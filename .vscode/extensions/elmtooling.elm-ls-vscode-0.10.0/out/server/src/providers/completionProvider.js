...
class CompletionProvider {
    constructor(connection, elmWorkspaces) {
        ...
        this.handleCompletionRequest = (params, elmWorkspace) => {
            ...
            if (tree) {
                ...
                else if (((_b = (_a = nodeAtPosition.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.type) === "record_expr") {
    ...
    getRecordCompletions(node, tree, range, imports, uri) {
        var _a, _b, _c, _d;
        const result = [];
        let typeDeclarationNode = treeUtils_1.TreeUtils.getTypeAliasOfRecord(node, tree, imports, uri);
        if (!typeDeclarationNode && ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.parent)) {
            typeDeclarationNode = treeUtils_1.TreeUtils.getTypeAliasOfRecordField(node.parent.parent, tree, imports, uri);
        }
        if (!typeDeclarationNode && ((_b = node.parent) === null || _b === void 0 ? void 0 : _b.parent)) {
            typeDeclarationNode = treeUtils_1.TreeUtils.getTypeOrTypeAliasOfFunctionRecordParameter(node.parent.parent, tree, imports, uri);
        }
        if (typeDeclarationNode) {
            const fields = treeUtils_1.TreeUtils.getAllFieldsFromTypeAlias(typeDeclarationNode);
            const typeName = (_d = (_c = treeUtils_1.TreeUtils.findFirstNamedChildOfType("upper_case_identifier", typeDeclarationNode)) === null || _c === void 0 ? void 0 : _c.text) !== null && _d !== void 0 ? _d : "";
